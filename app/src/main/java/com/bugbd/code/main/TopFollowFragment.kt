 ...
 * Use the [TopFollowFragment.newInstance] factory method to
...
class TopFollowFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.viewPager.adapter = TopFollowPagerAdapter(this)
        TabLayoutMediator(
            binding.tabLayout,
            binding.viewPager,
            configure
    ...
    companion object {
         ...
         * @return A new instance of fragment TopFollowFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TopFollowFragment().apply {
